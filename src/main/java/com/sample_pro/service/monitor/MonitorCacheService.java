...
public class MonitorCacheService {
    ...
    static {
        ...
        // ── 코일 비트 ──────────────────────────────────────────────────────
        COIL_ADDRS.put(1,  new int[]{2, 3, 8, 25, 39, 40, 44, 46, 50, 51, 56, 60, 96, 97, 98});
        COIL_ADDRS.put(2,  new int[]{2, 3, 8, 25, 39, 40, 44, 46, 50, 51, 56, 60, 96, 97, 98});
        COIL_ADDRS.put(3,  new int[]{2, 3, 8, 25, 39, 40, 44, 46, 51, 56, 60, 96, 97, 98});
        COIL_ADDRS.put(4,  new int[]{2, 3, 8, 25, 44, 46, 50, 51, 56, 60, 85, 86, 96, 97, 98});
        COIL_ADDRS.put(5,  new int[]{2, 8, 25, 38, 39, 46, 49, 52, 53, 54, 58, 62, 98, 99, 100});
        ...
        COIL_ADDRS.put(9,  new int[]{1, 2, 12, 14, 18, 19, 22, 25, 110, 111, 144, 145, 157,
                                      272, 273, 274, 275, 276, 277, 278, 279});
        COIL_ADDRS.put(10, new int[]{2, 8, 25, 38, 39, 46, 49, 52, 53, 54, 58, 62, 98, 99, 100});
