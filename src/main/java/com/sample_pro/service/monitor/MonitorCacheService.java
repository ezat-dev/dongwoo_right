...
public class MonitorCacheService {
    ...
    static {
        ...
        // ── 코일 비트 ──────────────────────────────────────────────────────
        COIL_ADDRS.put(1,  new int[]{2, 3, 8, 22, 25, 39, 40, 44, 46, 50, 51, 56, 60, 96, 97, 98, 106});
        COIL_ADDRS.put(2,  new int[]{2, 3, 8, 22, 25, 39, 40, 44, 46, 50, 51, 56, 60, 96, 97, 98, 106});
        ...
        COIL_ADDRS.put(5,  new int[]{2, 8, 25, 38, 39, 46, 48, 49, 52, 53, 54, 58, 62, 98, 99, 100, 108});
