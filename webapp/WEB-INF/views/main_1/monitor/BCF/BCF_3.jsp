...
<div class="page-wrap">
  ...
  <div class="group-1">
    ...
    <div class="bcf-1-detail">
      ...
      <img class="bcf-1-rotate-1 bcf3_" src="<%= ctx %>/img/bcf1/bcf-1-rotate-10.png" />
      <img class="bcf-1-rotate-2 bcf3_" src="<%= ctx %>/img/bcf1/bcf-1-rotate-20.png" />
      ...
      <img class="bcf-1-fire-1 bcf3_30" src="<%= ctx %>/img/bcf1/bcf-1-fire-10.png" />
      <img class="bcf-1-fire-2  bcf3_16" src="<%= ctx %>/img/bcf1/bcf-1-fire-20.png" />
    </div>
