  ...
  <div class="group-1">
      ...
      <div class="bcf-top-row">
        ...
        <div class="bcf-auto-panel">
          ...
          <div class="auto-list">
            ...
            <div class="auto-item state-red" data-tag="bcf5_20"  data-text-0="비상정지"            data-text-1="비상정지">비상정지</div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <!-- 확산2 → BCF5_40046 -->
        <td colspan="2"><div class="zbox cyan BCF5_40046">BCF5_40046</div></td>
        <!-- 강온 → empty -->
        <td colspan="2"><div class="zbox empty"></div></td>
        <!-- 로냉 → empty -->
        <td colspan="2"><div class="zbox empty"></div></td>
