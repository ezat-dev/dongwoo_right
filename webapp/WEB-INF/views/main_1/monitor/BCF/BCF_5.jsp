...
<div class="page-wrap">
  ...
  <div class="group-1">
    ...
    <!-- ═══ 기존 설비 작화 (변경 없음) ═══ -->
      ...
      <img class="bcf-1-tray-3 bcf5_50" src="<%= ctx %>/img/bcf1/bcf-1-tray-30.png" />
      ...
      <img class="bcf-1-air-cycle bcf5_62" src="<%= ctx %>/img/bcf1/bcf-1-air-cycle0.png" />
      ...
      <img class="bcf-1-rotate-1 bcf5_60" src="<%= ctx %>/img/bcf1/bcf-1-rotate-10.png" />
      <img class="bcf-1-rotate-2 bcf5_60" src="<%= ctx %>/img/bcf1/bcf-1-rotate-20.png" />
      ...
      <div class="bcf-1-3-sok-box bcf5_49"></div>
          <div class="bcf-1-dt-2 bcf5_3 bcf5_40004"></div>
      <div class="bcf-1-dt-1 bcf5_51 bcf5_40002"></div>
      <div class="bcf-1-ro-on bcf2_52"></div>
      <!-- <div class="bcf-1-ro-off"></div> -->
      <div class="bcf-1-dt-3 bcf5_50 bcf5_40060"></div>
...
(function() {
  ...
  document.querySelectorAll('[class]').forEach(function(el) {
    el.className.split(/\s+/).forEach(function(cls) {
      if (/^bcf5_\d{1,4}$/.test(cls)) {
        if (!bitElMap[cls]) bitElMap[cls] = [];
        bitElMap[cls].push(el);
      } else if (/^bcf5_\d{5,}$/.test(cls) || /^BCF5_\d+$/.test(cls)) {
  ...
  function applyData(data) {
    ...
    Object.keys(bitElMap).forEach(function(tag) {
      ...
      bitElMap[tag].forEach(function(el) {
        if (tag === 'bcf5_59') {
          ...
          el.style.animation  = isOn ? 'bcf5-spin 3s linear infinite' : 'none';
        } else if (tag === 'bcf5_60') {
          el.style.visibility = isOn ? 'visible' : 'hidden';
          el.style.animation  = isOn ? 'bcf5-spin 3s linear infinite' : 'none';
        } else if (tag === 'bcf5_62') {
          el.style.visibility = isOn ? 'visible' : 'hidden';
          el.style.animation  = isOn ? 'bcf-air-blink 2s ease-in-out infinite' : 'none';
        } else {
          el.style.visibility = isOn ? 'visible' : 'hidden';
        }
      });
    ...
    /* 사이클 이미지: bcf5_39 or bcf5_40 중 하나라도 1이면 서서히 나타남 */
    var cycleOn = (data['bcf5_39'] === 1 || data['bcf5_40'] === 1);
    ['bcf5_39', 'bcf5_40'].forEach(function(tag) {
