  ...
  <div class="group-2">
    ...
    <div class="bcf7-auto-panel">
      ...
      <div class="bcf7-auto-grid">
        ...
        <div class="bcf7-auto-item state-gray" data-tag="bcf7_152" data-gray="true" data-text-0="자동스텝1 준비완료" data-text-1="자동스텝1 준비완료">자동스텝1 준비완료</div>
        <div class="bcf7-auto-item state-gray" data-tag="bcf7_149" data-gray="true" data-text-0="자동SS(입구)"       data-text-1="자동SS(입구)"      >자동SS(입구)</div>
        <div class="bcf7-auto-item state-gray" data-tag="bcf7_153" data-gray="true" data-text-0="자동스텝2 준비완료" data-text-1="자동스텝2 준비완료">자동스텝2 준비완료</div>
        <div class="bcf7-auto-item state-gray" data-tag="bcf7_150" data-gray="true" data-text-0="자동SS(출구)"       data-text-1="자동SS(출구)"      >자동SS(출구)</div>
        <div class="bcf7-auto-item state-gray" data-tag="bcf7_151" data-gray="true" data-text-0="PLC 컨트롤 (PC OFF)" data-text-1="PLC 컨트롤 (PC OFF)">PLC 컨트롤 (PC OFF)</div>
        <div class="bcf7-auto-item state-gray" data-tag="bcf7_145" data-gray="true" data-text-0="유조 처리품 없음"   data-text-1="유조 처리품 없음"  >유조 처리품 없음</div>
      </div>
    </div>
