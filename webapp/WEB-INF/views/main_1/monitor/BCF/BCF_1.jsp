...
<div class="page-wrap">
  ...
  <div class="group-1">
    ...
    <!-- ═══ 기존 설비 작화 (변경 없음) ═══ -->
      ...
      <img class="bcf-1-rotate-1 bcf1_" src="<%= ctx %>/img/bcf1/bcf-1-rotate-10.png" />
      <img class="bcf-1-rotate-2 bcf1_" src="<%= ctx %>/img/bcf1/bcf-1-rotate-20.png" />
      ...
      <img class="bcf-1-fire-1 bcf1_30" src="<%= ctx %>/img/bcf1/bcf-1-fire-10.png" />
      <img class="bcf-1-fire-2  bcf1_16" src="<%= ctx %>/img/bcf1/bcf-1-fire-20.png" />
    </div>
